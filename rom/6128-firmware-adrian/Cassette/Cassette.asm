...
;; clear
        ...
        jp      JB_HI_KL_LDIR        ;{{257c:c3a1ba}} ; HI: KL LDIR			
...
transfer_loaded_block_to_destination_location:;{{Addr=$263c Code Calls/jump count: 1 Data use count: 0}}
        ...
        ld      a,d               ;{{2645:7a}} 
        sbc     a,h               ;{{2646:9c}} 
        jp      c,JB_HI_KL_LDIR      ;{{2647:daa1ba}} ; HI: KL LDIR
        add     hl,bc             ;{{264a:09}} 
        dec     hl                ;{{264b:2b}} 
        ex      de,hl             ;{{264c:eb}} 
        add     hl,bc             ;{{264d:09}} 
        dec     hl                ;{{264e:2b}} 
        ex      de,hl             ;{{264f:eb}} 
        jp      JB_HI_KL_LDDR        ;{{2650:c3a7ba}} ; HI: KL LDDR
...
_test_and_delay_40:               ;{{Addr=$2844 Code Calls/jump count: 1 Data use count: 0}}
        push    bc                ;{{2844:c5}} 
        push    de                ;{{2845:d5}} 
        call    JB_TXT_WR_CHAR       ;{{2846:cd3513}}  TXT WR CHAR
        pop     de                ;{{2849:d1}} 
        pop     bc                ;{{284a:c1}} 
        inc     de                ;{{284b:13}} 
...
x2891_code:                       ;{{Addr=$2891 Code Calls/jump count: 2 Data use count: 0}}
        call    JB_TXT_GET_CURSOR    ;{{2891:cd7c11}}  TXT GET CURSOR
        dec     h                 ;{{2894:25}} 
...
prepare_display_for_message:      ;{{Addr=$28d2 Code Calls/jump count: 1 Data use count: 0}}
        ...
        call    JB_KM_FLUSH          ;{{28db:cdfe1b}}  KM FLUSH
        call    JB_TXT_CUR_ON        ;{{28de:cd7612}}  TXT CUR ON
        call    JB_KM_WAIT_KEY       ;{{28e1:cddb1c}}  KM WAIT KEY
        call    JB_TXT_CUR_OFF       ;{{28e4:cd7e12}}  TXT CUR OFF
        cp      $fc               ;{{28e7:fefc}} 
        ret     z                 ;{{28e9:c8}} 
...
_prepare_display_for_message_14:  ;{{Addr=$28f0 Code Calls/jump count: 5 Data use count: 0}}
        jp      JB_TXT_OUTPUT        ;{{28f0:c3fe13}}  TXT OUTPUT
...
set_column_1:                     ;{{Addr=$28f3 Code Calls/jump count: 2 Data use count: 0}}
        ...
        push    hl                ;{{28f4:e5}} 
        ld      a,$01             ;{{28f5:3e01}} 
        call    JB_TXT_SET_COLUMN    ;{{28f7:cd5a11}}  TXT SET COLUMN
        pop     hl                ;{{28fa:e1}} 
        pop     af                ;{{28fb:f1}} 
        ret                       ;{{28fc:c9}} 
...
determine_if_word_can_be_displayed_on_this_line:;{{Addr=$28fd Code Calls/jump count: 3 Data use count: 0}}
        push    de                ;{{28fd:d5}} 
        call    JB_TXT_GET_WINDOW    ;{{28fe:cd5212}}  TXT GET WINDOW
        ld      e,h               ;{{2901:5c}} 
        call    JB_TXT_GET_CURSOR    ;{{2902:cd7c11}}  TXT GET CURSOR
        ld      a,h               ;{{2905:7c}} 
        dec     a                 ;{{2906:3d}} 
        add     a,e               ;{{2907:83}} 
        add     a,b               ;{{2908:80}} 
...
enable_key_checking_and_start_the_cassette_motor:;{{Addr=$29e3 Code Calls/jump count: 3 Data use count: 0}}
        ...
        push    hl                ;{{29e8:e5}} 
        push    de                ;{{29e9:d5}} 
        call    JB_SOUND_RESET       ;{{29ea:cde91f}}  SOUND RESET
        pop     de                ;{{29ed:d1}} 
        pop     ix                ;{{29ee:dde1}} 
...
delay__check_for_escape:          ;{{Addr=$2be2 Code Calls/jump count: 3 Data use count: 0}}
        ...
        call    JB_KM_TEST_KEY       ;{{2be9:cd451e}} ; check for escape pressed (km test key)
